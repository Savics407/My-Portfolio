...
import body from './assets/reico/body.svg'
import login from './assets/reico/login.png'
import avater from './assets/reico/setAvater.png'
import setup from './assets/reico/setup.png'
import signup from './assets/reico/signup.png'
import success from './assets/reico/AvaterSuccess.png'
import otp from './assets/reico/OTP.png'
            ...
            <div className='glow hidden md:flex lg:h-[400px] h-[400px] px-10 items-end justify-center py-20'>
                <div className="text-center ">
                    <motion.h1
                        ...
                        className='text-intro font-josefin text-3xl lg:text-4xl mb-3'>REICo</motion.h1>
                </div>
